...
var SharedPreferences.doubleTapSeekTime: Int
    get() = when (val value = all[DOUBLE_TAP_SEEK_TIME_KEY]) {
        is Int -> value
        is String -> value.toIntOrNull() ?: DOUBLE_TAP_SEEK_TIME_DEFAULT
        else -> DOUBLE_TAP_SEEK_TIME_DEFAULT
    }
    set(value) = edit {
        putString(DOUBLE_TAP_SEEK_TIME_KEY, value.toString())
    }
