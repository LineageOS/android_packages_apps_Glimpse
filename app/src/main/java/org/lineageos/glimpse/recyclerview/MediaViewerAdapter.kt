    ...
    class MediaViewHolder(
        ...
        fun bind(media: Media, position: Int) {
            ...
            if (media.mediaType == MediaType.IMAGE) {
                val listener = object : SubsamplingScaleImageView.DefaultOnImageEventListener() {
                    override fun onImageLoaded() {
                        //TODO; startPostponedEnterTransitionUnit()
                    }
                }
                imageView.setOnImageEventListener(listener)
