...
class MediaViewerAdapter(
    ...
    inner class MediaViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val mediaPositionObserver: (Int?) -> Unit = { currentPosition: Int? ->
            ...
            val isRegularVideo = media?.mediaType == MediaType.VIDEO
            val isMotionPhoto = media?.mediaType == MediaType.IMAGE && isPlayingMotionPhoto
            val isNowVideoPlayer = isCurrentlyDisplayedView && (isRegularVideo || isMotionPhoto)
