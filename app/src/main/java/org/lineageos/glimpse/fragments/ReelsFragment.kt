...
class ReelsFragment : Fragment(R.layout.fragment_reels) {
    ...
    private val adapter by lazy {
        object : SimpleListAdapter<ReelsViewModel.AlbumContent, View>(
            ...
            override fun ViewHolder.onBindView(item: ReelsViewModel.AlbumContent) {
                when (item) {
                    is ReelsViewModel.AlbumContent.DateHeader -> {
                    ...
                    is ReelsViewModel.AlbumContent.MediaItem -> {
    ...
    private suspend fun loadData() {
        viewModel.reelsWithHeader.collect {
