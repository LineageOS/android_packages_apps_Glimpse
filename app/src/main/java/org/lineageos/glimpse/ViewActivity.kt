...
class ViewActivity : AppCompatActivity(R.layout.activity_view) {
    ...
    private val toolbarInfoButton by lazy { toolbar.menu.findItem(R.id.info) }
    private val toolbarUseAsButton by lazy { toolbar.menu.findItem(R.id.useAs) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        uiModel.displayedMedia.observe(this@ViewActivity) { displayedMedia ->
            ...
            toolbarUseAsButton.isVisible = !secure

            // Update info button
            toolbarInfoButton.isVisible = mediaStoreMedia != null
